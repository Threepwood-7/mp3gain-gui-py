...
[`rsgain`](https://github.com/complexlogic/rsgain) is a fast ReplayGain scanner/apply tool with a strong focus on performance-oriented batch workflows.
It is a useful external reference when comparing throughput and ergonomics for large-library loudness processing pipelines.
...
- rsgain project: https://github.com/complexlogic/rsgain
